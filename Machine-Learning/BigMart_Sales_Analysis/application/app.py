...
@st.cache_resource
def load_model():
    model = pickle.load(open("Machine-Learning/BigMart_Sales_Analysis/Model/saved_model/model.pkl", "rb"))
    scaler = pickle.load(open("Machine-Learning/BigMart_Sales_Analysis/Model/saved_model/scaler.pkl", "rb"))
    lambda_ = pickle.load(open("Machine-Learning/BigMart_Sales_Analysis/Model/saved_model/lambda.pkl", "rb"))
    columns = pickle.load(open("Machine-Learning/BigMart_Sales_Analysis/Model/saved_model/columns.pkl", "rb"))
    return model, scaler, lambda_, columns

@st.cache_data
def load_data():
    # 1. Đọc trực tiếp 2 file đã clean (gồm cả đặc trưng và biến mục tiêu)
    train_df = pd.read_csv("Machine-Learning/BigMart_Sales_Analysis/data/train_data/train.csv")
    test_df = pd.read_csv("Machine-Learning/BigMart_Sales_Analysis/data/test_data/test.csv")
    ...
    y_test_eval = pickle.load(open("Machine-Learning/BigMart_Sales_Analysis/Model/saved_model/y_test.pkl", "rb"))
    y_pred_eval = pickle.load(open("Machine-Learning/BigMart_Sales_Analysis/Model/saved_model/y_pred.pkl", "rb"))
